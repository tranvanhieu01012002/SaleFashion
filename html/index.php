...
<?php
include "../html/Create_object.php";
if (isset($_GET['id'])) {
    if ($_GET['id'] == -1 && isset($_GET['name'])) {
        echo '
            <script>
                alert(" Insert Successful ' . $_GET['name'] . '")
            </script>
        ';
    } else if ($_GET['id'] != -1 && isset($_GET['name'])) {
        echo '
            <script>
                alert(" Update Successful ' . $_GET['name'] . '")
            </script>
        ';
    } else {
        echo '
            <script>
                alert(" Please double check, Action do not successful")
            </script>
        ';
    }
}
if (isset($_GET['deleted'])) {
    if ($_GET['deleted'] == "success") {
        ...
        echo '
            <script>
                alert("Try again, deleted not Successful ")
            </script>
        ';
    }
}
...
<![endif]-->
    <!-- <link rel="stylesheet" href="../dist/table_style/css/style.css"> -->
    <link rel="stylesheet" href="../dist/css/style_handle.css">
</head>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="add-product.php?id=-1" aria-expanded="false"><i
                                    class="mdi mdi-alert-outline"></i><span class="hide-menu">Add</span></a></li>
